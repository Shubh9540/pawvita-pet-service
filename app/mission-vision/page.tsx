...
import { AboutMissionLight } from '@/components/sections/AboutMissionLight';
...
export default function MissionVisionPage() {
  ...
  return (
    <main className="bg-white min-h-screen font-primary">
      ...
      {/* 3. Breadcrumb */}
      <Breadcrumb data={commonData?.missionVisionBreadcrumb} />
      
      {/* 4. Mission & Vision */}
      <AboutMissionLight data={sectionData.AboutMissionLight?.variants?.PawVitaAboutMissionLight1} />
