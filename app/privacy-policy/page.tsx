...
export const metadata = {
  title: 'Privacy Policy - PawVita Pet Services',
...
export default function PrivacyPolicyPage() {
  ...
  const legalData = sectionData.Legal?.variants?.PrivacyPolicy;
  ...
  return (
    <main className="bg-white min-h-screen font-primary">
      ...
      {commonData?.privacyPolicyBreadcrumb && (
        <Breadcrumb data={commonData.privacyPolicyBreadcrumb} />
      )}
