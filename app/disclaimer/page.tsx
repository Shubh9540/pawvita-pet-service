...
export const metadata = {
  title: 'Disclaimer - PawVita Pet Services',
  description: 'Read the legal disclaimer for PawVita services.',
};
...
export default function DisclaimerPage() {
  ...
  const legalData = sectionData.Legal?.variants?.Disclaimer;
  ...
  return (
    <main className="bg-white min-h-screen font-primary">
      ...
      {commonData?.disclaimerBreadcrumb && (
        <Breadcrumb data={commonData.disclaimerBreadcrumb} />
      )}
