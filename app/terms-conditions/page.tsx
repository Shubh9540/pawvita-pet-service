...
export const metadata = {
  title: 'Terms & Conditions - PawVita Pet Services',
  description: 'Read the terms and conditions of using PawVita.',
};
...
export default function TermsConditionsPage() {
  ...
  const legalData = sectionData.Legal?.variants?.TermsConditions;
  ...
  return (
    <main className="bg-white min-h-screen font-primary">
      ...
      {commonData?.termsConditionsBreadcrumb && (
        <Breadcrumb data={commonData.termsConditionsBreadcrumb} />
      )}
